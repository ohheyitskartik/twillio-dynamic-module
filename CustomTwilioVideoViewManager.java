...
import static com.hrxmobileapp.CustomTwilioVideoMockView.Events.ON_AUDIO_CHANGED;
import static com.hrxmobileapp.CustomTwilioVideoMockView.Events.ON_CAMERA_SWITCHED;
import static com.hrxmobileapp.CustomTwilioVideoMockView.Events.ON_CONNECTED;
import static com.hrxmobileapp.CustomTwilioVideoMockView.Events.ON_CONNECT_FAILURE;
import static com.hrxmobileapp.CustomTwilioVideoMockView.Events.ON_DATATRACK_MESSAGE_RECEIVED;
import static com.hrxmobileapp.CustomTwilioVideoMockView.Events.ON_DISCONNECTED;
import static com.hrxmobileapp.CustomTwilioVideoMockView.Events.ON_DOMINANT_SPEAKER_CHANGED;
import static com.hrxmobileapp.CustomTwilioVideoMockView.Events.ON_NETWORK_QUALITY_LEVELS_CHANGED;
import static com.hrxmobileapp.CustomTwilioVideoMockView.Events.ON_PARTICIPANT_ADDED_AUDIO_TRACK;
import static com.hrxmobileapp.CustomTwilioVideoMockView.Events.ON_PARTICIPANT_ADDED_DATA_TRACK;
import static com.hrxmobileapp.CustomTwilioVideoMockView.Events.ON_PARTICIPANT_ADDED_VIDEO_TRACK;
import static com.hrxmobileapp.CustomTwilioVideoMockView.Events.ON_PARTICIPANT_CONNECTED;
import static com.hrxmobileapp.CustomTwilioVideoMockView.Events.ON_PARTICIPANT_DISABLED_AUDIO_TRACK;
import static com.hrxmobileapp.CustomTwilioVideoMockView.Events.ON_PARTICIPANT_DISABLED_VIDEO_TRACK;
import static com.hrxmobileapp.CustomTwilioVideoMockView.Events.ON_PARTICIPANT_DISCONNECTED;
import static com.hrxmobileapp.CustomTwilioVideoMockView.Events.ON_PARTICIPANT_ENABLED_AUDIO_TRACK;
import static com.hrxmobileapp.CustomTwilioVideoMockView.Events.ON_PARTICIPANT_ENABLED_VIDEO_TRACK;
import static com.hrxmobileapp.CustomTwilioVideoMockView.Events.ON_PARTICIPANT_REMOVED_AUDIO_TRACK;
import static com.hrxmobileapp.CustomTwilioVideoMockView.Events.ON_PARTICIPANT_REMOVED_DATA_TRACK;
import static com.hrxmobileapp.CustomTwilioVideoMockView.Events.ON_PARTICIPANT_REMOVED_VIDEO_TRACK;
import static com.hrxmobileapp.CustomTwilioVideoMockView.Events.ON_STATS_RECEIVED;
import static com.hrxmobileapp.CustomTwilioVideoMockView.Events.ON_VIDEO_CHANGED;


public class CustomTwilioVideoViewManager extends SimpleViewManager<CustomTwilioVideoMockView> {
    ...
    private CustomTwilioVideoMockView configureView(ThemedReactContext reactContext){
        CustomTwilioVideoMockView mainView = null;
        try {
            Class mainViewCall = Class.forName("com.example.dynamic_module_twillio.CustomTwilioVideoView");
            Constructor<?> constructor = mainViewCall.getConstructor(ThemedReactContext.class);
            mainView = (CustomTwilioVideoMockView) constructor.newInstance(reactContext);
    ...
    @Override
    protected CustomTwilioVideoMockView createViewInstance(ThemedReactContext reactContext) {
    ...
    @Override
    public void receiveCommand(CustomTwilioVideoMockView view, int commandId, @Nullable ReadableArray args) {
        switch (commandId) {
