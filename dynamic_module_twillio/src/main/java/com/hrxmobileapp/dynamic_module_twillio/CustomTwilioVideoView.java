...
import static com.example.dynamic_module_twillio.CustomTwilioVideoView.Events.ON_AUDIO_CHANGED;
import static com.example.dynamic_module_twillio.CustomTwilioVideoView.Events.ON_CAMERA_SWITCHED;
import static com.example.dynamic_module_twillio.CustomTwilioVideoView.Events.ON_CONNECTED;
import static com.example.dynamic_module_twillio.CustomTwilioVideoView.Events.ON_CONNECT_FAILURE;
import static com.example.dynamic_module_twillio.CustomTwilioVideoView.Events.ON_DATATRACK_MESSAGE_RECEIVED;
import static com.example.dynamic_module_twillio.CustomTwilioVideoView.Events.ON_DISCONNECTED;
import static com.example.dynamic_module_twillio.CustomTwilioVideoView.Events.ON_DOMINANT_SPEAKER_CHANGED;
import static com.example.dynamic_module_twillio.CustomTwilioVideoView.Events.ON_NETWORK_QUALITY_LEVELS_CHANGED;
import static com.example.dynamic_module_twillio.CustomTwilioVideoView.Events.ON_PARTICIPANT_ADDED_AUDIO_TRACK;
import static com.example.dynamic_module_twillio.CustomTwilioVideoView.Events.ON_PARTICIPANT_ADDED_DATA_TRACK;
import static com.example.dynamic_module_twillio.CustomTwilioVideoView.Events.ON_PARTICIPANT_ADDED_VIDEO_TRACK;
import static com.example.dynamic_module_twillio.CustomTwilioVideoView.Events.ON_PARTICIPANT_CONNECTED;
import static com.example.dynamic_module_twillio.CustomTwilioVideoView.Events.ON_PARTICIPANT_DISABLED_AUDIO_TRACK;
import static com.example.dynamic_module_twillio.CustomTwilioVideoView.Events.ON_PARTICIPANT_DISABLED_VIDEO_TRACK;
import static com.example.dynamic_module_twillio.CustomTwilioVideoView.Events.ON_PARTICIPANT_DISCONNECTED;
import static com.example.dynamic_module_twillio.CustomTwilioVideoView.Events.ON_PARTICIPANT_ENABLED_AUDIO_TRACK;
import static com.example.dynamic_module_twillio.CustomTwilioVideoView.Events.ON_PARTICIPANT_ENABLED_VIDEO_TRACK;
import static com.example.dynamic_module_twillio.CustomTwilioVideoView.Events.ON_PARTICIPANT_REMOVED_AUDIO_TRACK;
import static com.example.dynamic_module_twillio.CustomTwilioVideoView.Events.ON_PARTICIPANT_REMOVED_DATA_TRACK;
import static com.example.dynamic_module_twillio.CustomTwilioVideoView.Events.ON_PARTICIPANT_REMOVED_VIDEO_TRACK;
import static com.example.dynamic_module_twillio.CustomTwilioVideoView.Events.ON_STATS_RECEIVED;
import static com.example.dynamic_module_twillio.CustomTwilioVideoView.Events.ON_VIDEO_CHANGED;
...
public class CustomTwilioVideoView extends View implements LifecycleEventListener, AudioManager.OnAudioFocusChangeListener {
    ...
    @StringDef({ON_CAMERA_SWITCHED,
            ...
            ON_PARTICIPANT_ADDED_VIDEO_TRACK,
            ON_DATATRACK_MESSAGE_RECEIVED,
            ON_PARTICIPANT_ADDED_DATA_TRACK,
            ON_PARTICIPANT_REMOVED_DATA_TRACK,
            ON_PARTICIPANT_REMOVED_VIDEO_TRACK,
            ON_PARTICIPANT_ADDED_AUDIO_TRACK,
            ON_PARTICIPANT_REMOVED_AUDIO_TRACK,
            ON_PARTICIPANT_ENABLED_VIDEO_TRACK,
            ON_PARTICIPANT_DISABLED_VIDEO_TRACK,
            ON_PARTICIPANT_ENABLED_AUDIO_TRACK,
            ON_PARTICIPANT_DISABLED_AUDIO_TRACK,
            ON_STATS_RECEIVED,
            ON_NETWORK_QUALITY_LEVELS_CHANGED,
